...
The system predicts scene depth from a single RGB image, detects objects, generates 3D coordinates, calculates inter-object distances, performs risk analysis, and produces annotated visualizations through a FastAPI-powered 
